...
class CrearDeudaActivity : AppCompatActivity() {
    ...
    private fun configurarSpinners() {
        ...
        when (intent.getStringExtra("DEFAULT_ACCION")) {
            "presto" -> spAccion.setText("Devolución de deuda", false)
            "me_prestaron" -> spAccion.setText("Aumento de deuda", false)
        }
        ...
        accountRepo.subscribeAccounts(uid) { list ->
            ...
            // Actualiza label cantidad con la moneda de la cuenta
