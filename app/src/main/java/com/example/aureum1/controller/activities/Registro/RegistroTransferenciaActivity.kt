...
class RegistroTransferenciaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Configurar menú contextual: ocultar cuenta bancaria y renombrar a Guardar Transferencia
        toolbar.menu.findItem(R.id.action_guardar_overflow)?.isVisible = false
        toolbar.menu.findItem(R.id.action_guardar)?.title = "Guardar Transferencia"
