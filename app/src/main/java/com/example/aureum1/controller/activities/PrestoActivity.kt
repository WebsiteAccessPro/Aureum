...
class PrestoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tilNombre = findViewById(R.id.tilNombrePresto)
        tilCuenta = findViewById(R.id.tilCuentaPresto)
        tilCantidad = findViewById(R.id.tilCantidadPresto)
        tilFecha = findViewById(R.id.tilFechaPresto)
        tilVenc = findViewById(R.id.tilVencPresto)
    ...
    private fun guardar() {
        ...
        // validaciones sin espacio extra
        if (nombre.isBlank()) {
